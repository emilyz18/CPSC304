DROP TABLE FINANCIAL_MARKET_HOURS CASCADE CONSTRAINTS;
DROP TABLE FINANCIAL_MARKET_INFO CASCADE CONSTRAINTS;
DROP TABLE STOCK_MARKET CASCADE CONSTRAINTS;
DROP TABLE BOND_MARKET CASCADE CONSTRAINTS;
DROP TABLE USER_ADDRESS_INFO CASCADE CONSTRAINTS;
DROP TABLE USER_CONTACT_INFO CASCADE CONSTRAINTS;
DROP TABLE USER_INFO CASCADE CONSTRAINTS;
DROP TABLE User_In_Financial CASCADE CONSTRAINTS;
DROP TABLE HAS_ACCOUNT CASCADE CONSTRAINTS;
DROP TABLE PUBLIC_TRADED_COMPANY CASCADE CONSTRAINTS;
DROP TABLE PUBLIC_TRADED_COMPANY_DETAILS CASCADE CONSTRAINTS;
DROP TABLE OWNS_PTC_STOCK_STOCK CASCADE CONSTRAINTS;
DROP TABLE HAVE_STOCK CASCADE CONSTRAINTS;
DROP TABLE BOND CASCADE CONSTRAINTS;
DROP TABLE HAVE_BOND CASCADE CONSTRAINTS;
DROP TABLE CREATE_WATCHLIST CASCADE CONSTRAINTS;
DROP TABLE ISSUE_PTC_BOND_CORPORATEBOND CASCADE CONSTRAINTS;
DROP TABLE GOVERNMENT CASCADE CONSTRAINTS;
DROP TABLE ISSUE_GOVERNMENT_BOND_GOVERNMENTBOND CASCADE CONSTRAINTS;
DROP TABLE OPERATES_STOCK CASCADE CONSTRAINTS;
DROP TABLE OPERATES_BOND CASCADE CONSTRAINTS;
DROP TABLE INCLUDES_STOCK CASCADE CONSTRAINTS;
DROP TABLE INCLUDES_BOND CASCADE CONSTRAINTS;
